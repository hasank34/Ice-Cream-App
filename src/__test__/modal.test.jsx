...
describe("Modal Component", () => {
  ...
  it("isOpen değerine göre modal ekrana basılır", () => {
    // useSelector çağrıldığında return etmesi gereken veriyi söyle
    ...
    // isOpen true gönder tekrar renderla
  ...
  it("sepetin doluluk durumuna göre ekrana uyarı basılır", () => {
    // useSelector çağrılınca boş sepet döndür
    useSelector.mockReturnValue({ cart: [] });
    // bileşeni renderla
